...
def cli(ctx):
    ...
    Create and delete AgentCore memory resources for the my app template application.
    """
...
@cli.command()
@click.option(
    "--name", default="MyAppMemory", help="Name of the memory resource"
)
@click.option(
    "--ssm-param",
    default="/app/myapp/agentcore/memory_id",
...
def create(name, ssm_param, event_expiry_days):
    ...
    try:
        ...
        memory = memory_client.create_memory_and_wait(
            ...
            description="Memory for my app templateagent",
