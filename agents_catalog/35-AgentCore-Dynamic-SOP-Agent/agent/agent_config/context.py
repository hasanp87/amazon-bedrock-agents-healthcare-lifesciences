...
class TemplateContext:
    """Context Manager for Template Assistant"""
    ...
    _agent: Optional[TemplateAgent] = None
    ...
    _agent_ctx: ContextVar[Optional[TemplateAgent]] = ContextVar(
        "agent", default=None
    )
    ...
    @classmethod
    def set_agent_ctx(cls, agent: TemplateAgent) -> None:
        # Set both global state and context variable
        cls._agent = agent
